...
**Validation:** the two independent clean references (closed-loop `none` runs vs EXP) agree within 2–15% at every Eb/N0. Re-scoring the 2026-09-21 run: 95.6% per-run mean (95.3% per-threat), 37/41 runs restored, 4 marginal, 0 not restored, 1 missed detection; speed sweep 94.7–96.9% at every speed (95.6% overall). Previous metric on the same runs: 76.3% / 72.4%.
