...
%   Implemented: jamming (barrage), noise_burst, path_loss, antenna_fault, spoofing.
...
switch lower(p.active_threat)
    ...
    case 'spoofing'
        ...
        % Unlike jamming (random noise), the spoof is a structured QPSK waveform, so the
        % demodulator sees two overlapping valid constellations and cannot tell them apart.
        spoofAmp = 10^(p.spoof_sir_db / 20);   % spoof amplitude relative to unit-power signal
        chart_th.Script = sprintf([ ...
            'function y = fcn(u)\n' ...
            '%%#codegen\n' ...
            'spoofAmp = %.6f;\n' ...
